	...
	<div class="container  pt-4 mb-5 pb-4 col-10 " style="text-align: center; background-image: linear-gradient( white, rgb(88, 148, 245)); border-radius: 15px;box-shadow: 5px 5px 5px rgba(0,0,0,0.5); margin-top: -150px;" > 
		...
		<div class="row">
			...
			<div class="col-md-5 col-12 ">
				...
				<h6 class="ml-5" style="text-align: left;">Buscar sempre a satisfazer os clientes da melhor forma, prestando serviços de qualidade e acessibilidade.</h6>
				<h2 class="mt-2 " style="text-align: left; text-decoration: underline;"><li>Visão</li></h2>
