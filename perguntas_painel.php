...
<body>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-md-10">
        <h1 class="mt-5" style="text-align: center;">Alterações e Criações de Perguntas é feita nesta página! </h1>
        <h5 class="mt-4" style="text-align: center;">Todas a perguntas da página serão salvas nesta tabela e poderão ser manipuladas apenas por um administrador.</h5>
